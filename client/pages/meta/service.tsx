...
const TermsOfService: NextPage = () => (
  <div className="mx-auto my-12 prose dark:prose-invert">
    ...
    <p>
      The TivlotCV app stores and processes personal data that you have provided to us, to provide my Service. It&apos;s
      ...
      programs, compromise your phone&apos;s security features and it could mean that the TivlotCV app won&apos;t work
      properly or at all.
    </p>
